//package org.hl7eu.imagingmanifest;
//
...
//
//    public KosManifest( Attributes attributes) {
//      this.kos = attributes;
//    }
//
//
//    public KosManifest( MadoManifest dicomManifest) {
//        // SOP Class
...
//        kos.setString( Tag.InstanceCreationDate, VR.DA, DicomUtil.toDateString( new Date(), TimeZone.getDefault() ) );
//        kos.setString( Tag.InstanceCreationTime, VR.TM, DicomUtil.toTimeString( new Date(), TimeZone.getDefault() ) );
//
...
////  }
//
//  private void addSrContentModule(Attributes kos, MadoManifest dicomManifest) {
//        {

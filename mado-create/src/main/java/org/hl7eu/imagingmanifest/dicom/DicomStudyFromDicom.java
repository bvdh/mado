...
//import org.hl7eu.imagingmanifest.util.DicomUtil;
//
...
//    }
//
//    private MadoPatient createPatient(Attributes dcmObj) {
//        MadoPatient madoPatient = new MadoPatient();
//        madoPatient.setId( dcmObj.getString( Tag.PatientID ) );
//        madoPatient.setIdIssuer( dcmObj.getString( Tag.IssuerOfPatientID ) );
...
//            madoPatient.getNames().add( patientName );
//        }
...
//                madoPatient.getNames().add( otherPatientName );
//            }
//        }
//        if ( dcmObj.contains( Tag.PatientBirthDate ) ){
//            madoPatient.setBirthDate( DicomUtil.getDateFromDicomDateAndTime( dcmObj.getDate( Tag.PatientBirthDate ), dcmObj.getDate( Tag.PatientBirthTime ), TimeZone.getTimeZone( dicomStudy.getTimeZone()) ) );
//        }
//
//
//        madoPatient.setGender( dcmObj.getString(Tag.PatientSex) );
//
//        return madoPatient.isEmpty() ? null : madoPatient;
//    }
//

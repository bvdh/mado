...
//import org.hl7eu.imagingmanifest.loader.DicomFileLoader;
...
//
//      MadoConfiguration configuration = new MadoConfiguration();
//      configuration.setWebViewerURL("http:webviewer");
//      configuration.setWadoURL("http:wado");
//
